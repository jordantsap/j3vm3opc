...
class VirtueMartControllerVmplg_byPV extends VirtueMartControllerVmplg
{
	/*** OVERRIDE ***/
	...
	public function __construct($config = array())
	{
		...
		// HACK: Because VirtueMartControllerVmplg::__construct() is not same as JController::__construct() 
	...
	{
		if (in_array($name, array('cart', 'vmplg'))) {
			$name .= '_bypv';
		}
